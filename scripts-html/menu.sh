...
echo '           <li class="dropdown">' >> $menu
 echo '           <a href="#" class="dropdown-toggle" data-toggle="dropdown">Curriculum Vitae <b class="caret"></b></a>' >> $menu
  echo '           <ul class="dropdown-menu">' >> $menu
    ...
    echo '           <li><a href="index.html"><img src="img/uk.png" width="25" alt="English"/> English</a></li>' >> $menu
    echo '           <li><a href="index.html"><img src="img/fr.png" width="25" alt="French"/> Français</a></li>' >> $menu
